                    ...
                    <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                      ...
                      <Button
                        ...
                        sx={{ 
                          ...
                          textTransform: 'none',
                          fontSize: '0.9rem',
                          borderColor: isInWatchlist(currentMovie.id.toString()) ? '#e50914' : '#333',
                          color: isInWatchlist(currentMovie.id.toString()) ? '#e50914' : '#ffffff',
                          backgroundColor: isInWatchlist(currentMovie.id.toString()) ? 'rgba(229, 9, 20, 0.1)' : 'transparent',
                          '&:hover': {
                            borderColor: '#e50914',
